...
//Admin adm = new Admin();
 //Student_Operation op = new Student_Operation();
  ...
  //  adm = (Admin)session.getAttribute("currAdmin");
   ...
   if(std != null){
   List<Course> lc = op.ShowCourse(std.getId());
    ...
    List<Course> l = aop.retriveCourse();
%>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <form action="<%= response.encodeURL("Addcourse")%>" method="post">
...
<tr><td><input type="checkbox" name="co" value="<%= s.getName() %>"  ></td>
    ...
    <input type="reset" value="Reset"/><br><br>
            <a href="<%= response.encodeURL("Home.jsp")%>" ><h4>Back</h4></a>
</form>
        </form>
    </body>
</html>
