...
<html> 
    ...
    <table>
        <tr><td><li><a href="<%= response.encodeURL("addCourse.jsp")%>" ><h2>Reg Courses</h2></a></li> </td>
            <td></td>
            <td><li><a href="<%= response.encodeURL("deleteCourse.jsp")%>"><h2>Delete Course</h2></a></li></td>
            <td><li><a href="<%= response.encodeURL("updateProfile.jsp")%>"><h2>Edit Profile</h2></a></li></td>
            <td><li><a href="<%= response.encodeURL("ShowCourse.jsp")%>"><h2>Show Courses</h2></a></li></td>
        </tr>       
