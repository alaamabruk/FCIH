    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     StudentAction op =new StudentAction();
       AdminAction aop = new AdminAction();
        ...
        if(a!=null){
       url= "ShowAdminCourse.jsp";
       err="Course Deleted Success !";
        
        for(String a1 : a){
    aop.adminDeleteCourse(a1);
    }
            }
        else{
         url="adminDeleteCourse.jsp";
        err="Select Subject to Delete it !";
           
        }
         
    out.println("<div style='black:red'>"+err+"</div>");
